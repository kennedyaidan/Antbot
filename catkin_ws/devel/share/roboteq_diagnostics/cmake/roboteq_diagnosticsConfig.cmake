...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_diagnostics_SOURCE_PREFIX /home/smerc/AntBot/catkin_ws/src/roboteq/roboteq_diagnostics)
  set(roboteq_diagnostics_DEVEL_PREFIX /home/smerc/AntBot/catkin_ws/devel)
  ...
  set(roboteq_diagnostics_INSTALL_PREFIX /home/smerc/AntBot/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smerc/AntBot/catkin_ws/src/roboteq/roboteq_diagnostics/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT roboteq_diagnostics_NUM_DUMMY_TARGETS)
      set(roboteq_diagnostics_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::roboteq_diagnostics::wrapped-linker-option${roboteq_diagnostics_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR roboteq_diagnostics_NUM_DUMMY_TARGETS "${roboteq_diagnostics_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::roboteq_diagnostics::wrapped-linker-option${roboteq_diagnostics_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND roboteq_diagnostics_LIBRARIES "${interface_target_name}")
